	...
	<section class="section">
		...
		<div class="row justify-content-center">
			...
			<div class="post-body">
				...
				<h4>INFORMATION AUTOMATICALLY COLLECTED/ TRACKED WHILE NAVIGATION</h4>
				<h5>Cookies</h5>
				<p>
				...
				<h5>Opting out</h5>
				<p>
					If a User opts out using the Ads Settings, the unique DoubleClick cookie ID on the User's browser is overwritten with the phrase "OPTOUT". Because there is no longer a unique cookie ID, the opt-out cookie can't be associated with a particular browser.
				</p>
				...
				<h5>Demographic and other information:</h5>
				<p>
				...
				<h4>QUESTIONS / GRIEVANCE REDRESSAL</h4>
				<p>
					Redressal Mechanism: Any complaints, abuse or concerns with regards to the use, processing and disclosure of Information provided by you or breach of these terms should immediately be informed to the designated Grievance Officer/Data Protection Officer at grievanceofficer@timesgroup.com
				</p>
