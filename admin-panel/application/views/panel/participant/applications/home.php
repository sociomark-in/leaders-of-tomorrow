										...
										<div class="col-12 grid-margin stretch-card">
											<div class="card">
												<div class="card-body pb-3">
													...
													<div class="">
														<a href="<?= base_url('category/' . $category['code']) . '/nominate' ?>" class="btn btn-sm btn-primary">Apply Now</a>
														<a href="<?= app_url('awards/category/' . $category['code']) ?>" target="_blank" class="btn btn-sm btn-white">View Details</a>
													</div>
												</div>
												<div class="card-footer">
