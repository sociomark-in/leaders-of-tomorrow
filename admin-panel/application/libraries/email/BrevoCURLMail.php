...
class BrevoCURLMail
{
	 ...
	 * @param  mixed $to
	 * @param  mixed $subject
	 * @param  mixed $htmltemplate[template, data]
	 * @param  mixed $altbody
	 * @return void
	 */
	public function config_email($sender, $to, $subject, $htmlbody, $altbody = "")
	{
		// Generated by curl-to-PHP: http://incarnate.github.io/curl-to-php/
		$this->pool["sender"] = $sender ?? [
			"name" =>  "LOT Awards",
		...
		$this->pool["htmlContent"] = $htmlbody ?? $altbody;
		$this->pool["textContent"] = $altbody;
		$this->pool["subject"] = $subject ?? "Test Subject";
