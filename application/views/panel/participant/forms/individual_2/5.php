		...
		<div class="row g-3 mb-3">
			<div class="col-xl-3 col-lg-4 col-md-6 col-12">
				<div class="">
					...
					<input type="file" accept="application/pdf" name="doc1" class="dropify" data-default-file="<?= $application_temp['id_255401'] ?>" data-max-file-size="2M" data-allowed-file-extensions="pdf" />
					<span class="form-text">document supporting received from Ministry of MSME, Govt. of India / DPIIT certificate(PDF of Maximum Size 2MB)</span>
				</div>
			</div>
			<div class="col-xl-3 col-lg-4 col-md-6 col-12">
				<div class="">
					<label for="" class="form-label">Incorporation Certificate</label>
					<input type="file" accept="application/pdf" name="doc2" class="dropify" data-default-file="<?= $application_temp['id_255402'] ?>" data-max-file-size="2M" data-allowed-file-extensions="pdf" />
			...
			<div class="col-xl-3 col-lg-4 col-md-6 col-12">
				<div class="">
					...
					<span class="form-text">(e.g., Aadhaar, Passport, or Driver’s
						License)(PDF of Maximum Size 2MB)</span>
				</div>
			</div>
			<div class="col-xl-3 col-lg-4 col-md-6 col-12">
				<div class="">
					<label for="" class="form-label">Photographs or Videos of products/services offered</label>
					<input type="file" accept="application/pdf" name="doc4" class="dropify" data-default-file="<?= $application_temp['id_255406'] ?>" data-max-file-size="2M" data-allowed-file-extensions="pdf" />
			...
			<div class="col-xl-3 col-lg-4 col-md-6 col-12">
				<div class="">
					...
					<input type="file" accept="application/pdf" name="doc5" class="dropify" data-default-file="<?= $application_temp['id_255404'] ?>" data-max-file-size="2M" data-allowed-file-extensions="pdf" />
			...
			<div class="col-xl-3 col-lg-4 col-md-6 col-12">
				<div class="">
					...
					<input type="file" accept="application/pdf" name="doc6" class="dropify" data-default-file="<?= $application_temp['id_255405'] ?>" data-max-file-size="2M" data-allowed-file-extensions="pdf" />
