														...
														<tr>
															<td style="padding:0">
																<img src="https://ui-avatars.com/api/?name=Leaders+Tomorrow"
																	alt="" height="60" style="border-radius: 50%;">
															</td>
															<td style="font-size: 12px; color: #495664;line-height:1.5;">
																<strong><?= APP_NAME ?></strong> posted a new comment on nomination of <strong>Lorem ipsum dolor sit amet.</strong> <a href="" style="color: #b72026;text-decoration: none;">Go to My Account</a>
															</td>
														</tr>
														<tr>
															<td height="10" style="padding:0;"></td>
												...
												<td style="font-size:16px;line-height:1.5;padding-top:0">
													<div>
														...
														<div>
															...
															<div style="margin-bottom:20px;line-height:1.5">
																You have a new comment on nomination of <strong>Lorem ipsum dolor sit amet.</strong> of <strong><?= APP_NAME ?></strong> Kindly take appropriate action on
													...
													<div style="line-height:1.5">
														<a style="background:#b72026;padding:12px;font-size:18px;color:#fff;text-decoration: none;border-radius:3px;display:block;width:300px;margin:0 auto;text-align:center"
															href="https://connect.zoho.in/portal/intranet" target="_blank">
