...
<div class="wrapper">
    ...
    <?php if ( ! $this->facebooksdk->is_authenticated()) : ?>

        <div class="login">
            <a href="<?php echo $this->facebooksdk->login_url(); ?>">Login</a>
        </div>
    ...
    <?php else : ?>
        ...
        <div class="user-info">
            ...
            <p>
                <a href="<?php echo $this->facebooksdk->logout_url(); ?>">Logout</a>
            </p>
		...
		<div class="upload-form">
			<?php if ($this->input->post('imageFile')) {
				$response = $this->facebooksdk->user_upload_request(
