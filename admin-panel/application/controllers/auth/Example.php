...
class Example extends CI_Controller {
	...
	{
		$this->load->view('awards/examples/start');
	}
	...
	public function web_login()
	{
		...
		if ($this->facebooksdk->is_authenticated())
		{
			// User logged in, get user details
			$user = $this->facebooksdk->request('get', '/me?fields=id,name,email');
			if (!isset($user['error']))
			{
				$data['user'] = $user;
			}
		...
		// display view
		$this->load->view('awards/examples/web', $data);
	}
	...
	{
		// Load view
		$this->load->view('awards/examples/js');
	}
