				...
				<div class="row g-md-5 g-3">
						...
						<div class="row g-3">
							...
							<div class="col-12">
								<div class="row g-3">
									...
									<div class="col-xxl-4 col-lg-6 col-12">
										<select required name="organization_ratio" id="" class="form-select">
											<option value="">Select Option</option>
					...
					<fieldset class="col-12">
						...
						<div class="row g-3 mb-3">
							...
							<div class="col-xl-3 col-lg-4 col-md-6 col-12">
								<div class="">
									<label for="" class="form-label">Proof of Age &nbsp;<a class="link-icon" href="<?= base_url($application['id_255403']) ?>" target="_blank">View Document<i class="mb-1 px-1" data-feather="external-link"></i></a></label>
							...
							<div class="col-xl-3 col-lg-4 col-md-6 col-12">
								<div class="">
									...
									<input type="file" accept="application/pdf" name="doc4" class="dropify" data-default-file="<?= $application['id_255406'] ?>" data-max-file-size="2M" data-allowed-file-extensions="pdf" />
							...
							<div class="col-xl-3 col-lg-4 col-md-6 col-12">
								<div class="">
									...
									<input type="file" accept="application/pdf" name="doc5" class="dropify" data-default-file="<?= $application['id_255404'] ?>" data-max-file-size="2M" data-allowed-file-extensions="pdf" />
							...
							<div class="col-xl-3 col-lg-4 col-md-6 col-12">
								<div class="">
									...
									<input type="file" accept="application/pdf" name="doc6" class="dropify" data-default-file="<?= $application['id_255405'] ?>" data-max-file-size="2M" data-allowed-file-extensions="pdf" />
