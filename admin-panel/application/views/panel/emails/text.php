							...
							<tr>
								<td style="width: 50px;" align="center">
									<a href="" style="color: #1d1d1d;">
										<svg style="height:30px;" class="svg-inline--fa fa-linkedin-in"
								...
								<td style="width: 50px;" align="center">
									<a href="" style="color: #1d1d1d;">
										<svg style="height:30px" class="svg-inline--fa fa-instagram" aria-hidden="true"
								...
								<td style="width: 50px;" align="center">
									<a href="" style="color: #1d1d1d;">
										<svg style="height:30px" class="svg-inline--fa fa-x-twitter" aria-hidden="true"
					...
					<td>
						<div
							...
							*Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam, dolor
							blanditiis numquam dolorem qui error sequi quibusdam provident eligendi nisi
							illum, ducimus ullam officiis sed, accusantium asperiores iure cum sit.
						</div>
					</td>
				</tr>
			</tfoot>
