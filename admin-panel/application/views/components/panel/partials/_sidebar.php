		...
		<ul class="nav">
			...
			<?php if (in_array($_SESSION['awards_panel_user']['role'], ['participant'])) : ?>
				...
				<?php if ($_SESSION['awards_panel_user']['is_nominated']) : ?>
					<li class="nav-item <?= link_is_active("my-presentations") ?>">
						<a href="<?= base_url('my-presentations') ?>" class="nav-link">
			...
			<?php if (in_array($_SESSION['awards_panel_user']['role'], ['partner', 'jury', 'admin', 'super-admin'])) : ?>
				...
				<li class="nav-item <?= link_is_active("presentations") ?>">
					<a href="<?= base_url('presentations') ?>" class="nav-link">
						<i class="link-icon" data-feather="layers"></i>
						<span class="link-title">Presentations</span>
					</a>
				</li>
			...
			<?php if (in_array($_SESSION['awards_panel_user']['role'], ['admin', 'super-admin'])) : ?>
				...
				<!-- <li class="nav-item <?= link_is_active("all-users") ?>">
					<a href="<?= base_url('all-users') ?>" class="nav-link">
						<i class="link-icon" data-feather="users"></i>
						<span class="link-title">All Users</span>
					</a>
				</li> -->
				<li class="nav-item <?= link_is_active("all-agents") ?>">
					<a href="<?= base_url("all-agents") ?>" class="nav-link">
						<i class="link-icon" data-feather="users"></i>
