				...
				<div class="row g-3">
					...
					<div class="col-xxl-3 col-xl-4 col-lg-6 col-12">
						<div class="">
							...
							<input required type="number" value="<?= $application_temp['id_255203'] ?>" name="organization[beneficiary]" class="form-control">
						</div>
					</div>
					<div class="col-xxl-4 col-xl-3 col-lg-6 col-12">
						<div class="">
							<label for="" class="form-label">No. of community members directly impacted </label>
							<input required type="number" value="<?= $application_temp['id_255204'] ?>" name="organization[community_impact]" class="form-control">
						</div>
					</div>
					<div class="col-xxl-4 col-xl-3 col-lg-6 col-12">
						<div class="">
							<label for="" class="form-label">% of profits reinvested into social initiatives</label>
							<input required type="number" value="<?= $application_temp['id_255205'] ?>" name="organization[investment]" class="form-control">
						</div>
					</div>
