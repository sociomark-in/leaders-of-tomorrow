						...
						<div class="card input-group-card">
							<div class="card-body">
								...
								switch ($tabs[$i]['identifier']) {
									case 'profile':
										$this->load->view('panel/participant/forms/family/1', $data);
										break;
									case 'finance':
										$this->load->view('panel/participant/forms/family/2', $data);
										break;
									case 'case_1':
										$this->load->view('panel/participant/forms/family/3', $data);
										break;
									case 'case_2':
										$this->load->view('panel/participant/forms/family/4', $data);
										break;
									case 'uploads':
										$this->load->view('panel/participant/forms/family/5', $data);
										break;
									case 'review':
										$this->load->view('panel/participant/forms/family/review', $data);
										break;
									case 'success':
