...
$this->pdf->addPage();
$this->pdf->SetFont('Arial', 'B', 18);
$this->pdf->MultiCell(300, 10, ucwords(strtolower("Share your journey as a social entepreneur and your inspiration")), 0, 'L');
$this->pdf->SetFont('Arial', '', 16);
...
$this->pdf->addPage();
$this->pdf->SetFont('Arial', 'B', 18);
$this->pdf->MultiCell(300, 10, ucwords(strtolower("Highlight leadership initiatives and key milestones")), 0, 'L');
$this->pdf->SetFont('Arial', '', 16);
$this->pdf->Cell(300, 7, "", 0, 1, '', false);
...
$this->pdf->addPage();
$this->pdf->SetFont('Arial', 'B', 18);
$this->pdf->MultiCell(300, 10, ucwords(strtolower("Innovation & Problem-Solving")), 0, 'L');
$this->pdf->SetFont('Arial', '', 16);
$this->pdf->Cell(300, 7, "", 0, 1, '', false);
...
$this->pdf->addPage();
$this->pdf->SetFont('Arial', 'B', 18);
$this->pdf->MultiCell(300, 10, ucwords(strtolower("Market Impact")), 0, 'L');
$this->pdf->SetFont('Arial', '', 16);
$this->pdf->Cell(300, 7, "", 0, 1, '', false);
...
$this->pdf->addPage();
$this->pdf->SetFont('Arial', 'B', 18);
$this->pdf->MultiCell(300, 10, ucwords(strtolower("Social Responsibility & Community Impact")), 0, 'L');
$this->pdf->SetFont('Arial', '', 16);
$this->pdf->Cell(300, 7, "", 0, 1, '', false);
...
$this->pdf->addPage();
$this->pdf->SetFont('Arial', 'B', 18);
$this->pdf->MultiCell(300, 10, ucwords(strtolower("Scalability and Future Plans")), 0, 'L');
$this->pdf->SetFont('Arial', '', 16);
$this->pdf->Cell(300, 7, "", 0, 1, '', false);
