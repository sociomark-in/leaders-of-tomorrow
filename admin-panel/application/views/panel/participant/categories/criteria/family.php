...
<ul>
	...
	<li>All forms must be received by the management by latest January 31, 2026, 11:59pm IST</li>
	<li>Please provide up to 5 supporting documents wherever possible, to support your entry details. Supporting documents must be in the following formats only – pdf, doc, jpeg etc. Size of each document cannot exceed 2 MB</li>
	<li>Mandatory to attach MSME certificate document received from Ministry of MSME, Govt. of India</li>
	<li>The declaration (at the end of this form) must be signed by a senior functionary of the organization (MD/Owner/Director/Any other senior functionary with signing authority)</li>
	<li>Additional collaterals can be submitted in the form of a Google Drive link or attachment while submitting the application form itself on the website</li>
	<li>The final eligibility of the nominees is subject to the discretion and approval of the Award management and Jury</li>
	<li>In case of any queries relating to the application form or participation in the awards please contact to us on: <a href="mailto:lotmails@timesgroup.com">lotmails@timesgroup.com</a></li>
</ul>
