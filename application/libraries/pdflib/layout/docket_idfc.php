...
$this->pdf->Cell(47, 4, $data['nomination_id'] ?? "N/A", 0, 0, '');
...
$this->pdf->SetFont('Arial', 'B', 9);
$this->pdf->Cell(97, 6, $data['organization_name'] ?? "N/A", 0, 0, '');
$this->pdf->Cell(97, 6, $data['name'] ?? "N/A", 0, 1, '');

$this->pdf->SetFont('Arial', '', 9);
$this->pdf->Cell(63, 6, 'Designation', 0, 0, '');
$this->pdf->Cell(79, 6, 'Type of Entreprise', 0, 0, '');
$this->pdf->Cell(47, 6, 'Date of Company Incorporation', 0, 1, '');

$this->pdf->SetFont('Arial', 'B', 9);
$this->pdf->Cell(63, 4, $data['designation'] ?? "N/A", 0, 0, '');
$this->pdf->Cell(79, 4, $data['id_255003'] ?? "N/A", 0, 0, '');
$this->pdf->Cell(47, 4, $data['id_255002'] ?? "N/A", 0, 1, '');
...
$this->pdf->Cell(63, 6, 'Year of Association with IDFC FIRST Bank', 0, 0, '');
$this->pdf->Cell(63, 6, 'IDFC FIRST Bank Account Number', 0, 1, '');
$this->pdf->SetFont('Arial', 'B', 9);
$this->pdf->Cell(63, 4, $data['id_255201'] ?? "N/A" . ' Employees', 0, 0, '');
$this->pdf->Cell(63, 4, $data['id_255501'] ?? "N/A", 0, 0, '');
$this->pdf->Cell(63, 4, $data['id_255502'] ?? "N/A", 0, 1, '');

$this->pdf->Cell(0, 5, '', 0, 1, '');
$this->pdf->SetFont('Arial', '', 9);
$this->pdf->Cell(189, 6, 'Website URL', 0, 1, '');
$this->pdf->SetFont('Arial', 'B', 9);
$this->pdf->Cell(189, 3, $data['organization_url'] ?? "http://guardian.co.uk", 0, 1, '');
...
$this->pdf->SetFont('Arial', 'B', 9);
$this->pdf->Cell(63, 4, $data['id_255901'] ?? "N/A", 0, 0);
$this->pdf->Cell(79, 4, $data['id_255902'] ?? "N/A", 0, 0);
$this->pdf->Cell(47, 4, $data['id_255903'] ?? "N/A", 0, 1);
...
$this->pdf->SetFont('Arial', 'B', 9);
$this->pdf->Cell(63, 4, $data['id_255101'] ?? "N/A", 0, 0);
$this->pdf->Cell(63, 4, $data['id_255102'] ?? "N/A", 0, 1);

$this->pdf->Cell(0, 2, '', 0, 1, '');
$this->pdf->SetFont('Arial', '', 9);
$this->pdf->Cell(63, 4, 'Revenue Growth (in %)', 0, 0);
$this->pdf->SetFont('Arial', 'B', 9);
$this->pdf->Cell(63, 4, $data['id_255103'] ?? "N/A", 0, 1);

$this->pdf->Cell(0, 2, '', 0, 1, '');
$this->pdf->SetFont('Arial', '', 9);
$this->pdf->Cell(63, 4, 'No. Of Clients', 0, 0);
$this->pdf->SetFont('Arial', 'B', 9);
$this->pdf->Cell(63, 4, $data['id_255205'] ?? "N/A", 0, 1);
...
$this->pdf->SetFont('Arial', '', 9);
$this->pdf->SetTextColor(25, 25, 25);
$this->pdf->Cell(63, 4, $data['id_255201'] ?? "N/A", 0, 0);
$this->pdf->Cell(126, 4, $data['id_255202'] ?? "N/A", 0, 1);
...
$this->pdf->SetFont('Arial', '', 9);
$this->pdf->SetTextColor(25, 25, 25);
$this->pdf->MultiCell(0, 4, $data['id_255203'] ?? "N/A", 0);
...
$this->pdf->SetFont('Arial', '', 9);
$this->pdf->SetTextColor(25, 25, 25);
$this->pdf->MultiCell(0, 4, $data['id_255204'] ?? "N/A", 0);
...
$this->pdf->SetFont('Arial', '', 9);
$this->pdf->MultiCell(0, 4, $data['id_255301'] ?? "N/A", 0);
...
$this->pdf->Cell(0, 1, '', 0, 1, '');
$this->pdf->SetFont('Arial', '', 9);
$this->pdf->MultiCell(0, 4, $data['id_255302'] ?? "N/A", 0);
...
$this->pdf->Cell(0, 1, '', 0, 1, '');
$this->pdf->SetFont('Arial', '', 9);
$this->pdf->MultiCell(0, 4, $data['id_255303'] ?? "N/A", 0);
...
$this->pdf->Cell(0, 1, '', 0, 1, '');
$this->pdf->SetFont('Arial', '', 9);
$this->pdf->MultiCell(0, 4, $data['id_255304'] ?? "N/A", 0);
