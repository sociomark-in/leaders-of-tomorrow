		...
		<?php switch ($sb['name']) {
			case 'Mumbai': ?>
				<a href="<?= base_url('city/') . strtolower($sb['name']) ?>" class="tile interactive-tile">
					<div class="row justify-content-center" data-aos="fade-up" data-aos-delay="<?= $key * 100 ?>">
						<div class="col-auto">
							<div class="photo rounded-circle bg-red mb-3 p-2">
								<img src="<?= base_url("assets/images/icons/city/") ?>mumbai.png" alt="Mumbai" height="100">
							</div>
						</div>
						<div class="col">
			...
			default: ?>
				<a href="javascript:void(0)" class="tile">
					<div class="row" data-aos="fade-up" data-aos-delay="<?= $key * 100 ?>">
						<div class="col-auto">
							<div class="photo rounded-circle bg-red mb-3 p-2">
								<img src="<?= base_url("assets/images/icons/city/") ?>mumbai.png" alt="Mumbai" height="100">
							</div>
