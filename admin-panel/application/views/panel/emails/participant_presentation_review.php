												...
												<td style="line-height:22px;padding:0 30px 0">
													<div>
														...
														<div style="margin-bottom:10px;line-height:1.5">
															Thank you for submitting your presentation for the <strong>IDFC FIRST Bank Presents ET NOW <?= APP_NAME ?> Awards 2026</strong>
														</div>
														<div style="margin-bottom:10px;line-height:1.5">
															We have received your entry with Unique ID <a style="text-decoration: none; color:#b72026;" href="<?= base_url('my-presentations') ?>">#<?= $application['nomination_id'] ?></a>
