...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 21, 2024 at 02:29 PM
...
(1, '1726918370-Qjlq', 1, 'Hemant Karekar', 'hemant@sociomark.in', '13/07/1999', 'Developer', '12 Months', 'Sociomark', 50, 'Manufacturing', 'Select 3', '17/09/2014', '1 Month', 'https://sociomark.in', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'https://cdnjs.com/libraries/Dropify', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Hemant Karekar', 'hemant@sociomark.in', '08689862375', '1', 3, 1, NULL, '2024-09-21 17:02:52');
...
CREATE TABLE `msme_entries` (
  ...
  `email` varchar(255) NOT NULL,
  `organization_name` varchar(200) NOT NULL,
  `75501` int(11) NOT NULL,
  `75502` varchar(255) NOT NULL,
  `organization_url` text NOT NULL,
  `75503` text DEFAULT NULL,
  `75504` text NOT NULL,
  `75505` varchar(200) NOT NULL,
  `75506` varchar(255) NOT NULL,
  `75507` varchar(20) NOT NULL,
  `75508` text NOT NULL,
  `75509` text NOT NULL,
  `75510` varchar(100) NOT NULL,
  `75511` varchar(100) NOT NULL,
  `75512` varchar(100) NOT NULL,
  `75513` varchar(100) NOT NULL,
  `75514` varchar(100) NOT NULL,
  `75515` varchar(100) NOT NULL,
  `75516` varchar(100) NOT NULL,
  `75517` varchar(100) NOT NULL,
  `75518` varchar(100) NOT NULL,
  `75519` varchar(100) NOT NULL,
  `75520` varchar(200) NOT NULL,
  `75521` varchar(60) NOT NULL,
  `75522` varchar(60) NOT NULL,
  `75523` text NOT NULL,
  `75524` text NOT NULL,
  `75525` text NOT NULL,
  `75526` text NOT NULL,
  ...
  `75533` text NOT NULL,
  `linkedin_url` text DEFAULT NULL,
  `75534` varchar(255) NOT NULL,
  `75535` varchar(255) NOT NULL,
  `75536` varchar(15) NOT NULL,
