...
$this->pdf->Cell(70, 15, "Particulars", 1, 0, '', true);
$this->pdf->Cell(70, 15, "Information", 1, 0, '', true);
$this->pdf->Cell(20, 15, "", 0, 0, true);
$this->pdf->Cell(70, 15, "Particulars", 1, 0, '', true);
$this->pdf->Cell(35, 15, "FY 2024", 1, 0, '', true);
$this->pdf->Cell(35, 15, "FY 2023", 1, 1, '', true);

$this->pdf->SetFont('Arial', '', 16);
$this->pdf->Cell(70, 15, "Type of Business", 1, 0, '', true);
$this->pdf->Cell(70, 15, $data['id_255004']??"", 1, 0, '', true);
$this->pdf->Cell(20, 15, "", 0, 0, true);
$this->pdf->Cell(70, 15, "Revenue Turnover (in Cr.)", 1, 0, '', true);
$this->pdf->Cell(35, 15, $data['id_255101']??"", 1, 0, '', true);
$this->pdf->Cell(35, 15, $data['id_255102']??"", 1, 1, '', true);

$this->pdf->SetFont('Arial', '', 16);
$this->pdf->Cell(70, 15, "No. Of Employees", 1, 0, '', true);
$this->pdf->Cell(70, 15, $data['id_255101']??"", 1, 0, '', true);
$this->pdf->Cell(20, 15, "", 0, 0, true);
$this->pdf->Cell(70, 15, "Revenue Growth (in %)", 1, 0, '', true);
$this->pdf->Cell(35, 15, $data['id_255103']??"", 1, 0, '', true);
$this->pdf->Cell(35, 15, $data['id_255104']??"", 1, 1, '', true);

$this->pdf->SetFont('Arial', '', 16);
$this->pdf->Cell(70, 15, "Incorporation Date", 1, 0, '', true);
$this->pdf->Cell(70, 15, $data['id_255002']??"", 1, 0, '', true);
$this->pdf->Cell(20, 15, "", 0, 0, true);
$this->pdf->Cell(70, 15, "Net Profit Margin", 1, 0, '', true);
$this->pdf->Cell(35, 15, $data['id_255105']??"", 1, 0, '', true);
$this->pdf->Cell(35, 15, $data['id_255106']??"", 1, 1, '', true);

$this->pdf->Cell(160, 15, "", 0, 0, true);
$this->pdf->Cell(70, 15, "Asset Valuation", 1, 0, '', true);
$this->pdf->Cell(35, 15, $data['id_255105']??"", 1, 0, '', true);
$this->pdf->Cell(35, 15, $data['id_255106']??"", 1, 1, '', true);

$this->pdf->Cell(160, 15, "", 0, 0, true);
$this->pdf->Cell(70, 15, "Debt Equity Ratio", 1, 0, '', true);
$this->pdf->Cell(35, 15, $data['id_255105']??"", 1, 0, '', true);
$this->pdf->Cell(35, 15, $data['id_255106']??"", 1, 1, '', true);
