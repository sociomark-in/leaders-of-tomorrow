                ...
                <td align="center">
                    <table border="0" cellpadding="0" cellspacing="0" bgcolor="#fff"
                        ...
                        <tbody>
                                        ...
                                        <tr>
                                            <td style="line-height:22px;padding:0 30px 0">
                                                ...
                                                <div>
                                                    ...
                                                    <div style="margin-bottom:10px;line-height:1.5">
                                                        Your request has been forwarded to the evaluation department for
                                                        review. Once reviewed and approved, you will receive a
                                                        registration confirmation email with the event details.
                                                    </div>
                                                    <div
                                                        style="margin-bottom:5px;color:#664d0c;line-height:1.5;background-color:#fff3cd;border-radius:3px;padding:10px">
                                                        Please note that unless you receive a registration confirmation,
                                                    ...
                                                    <div style="margin-bottom:10px;line-height:1.5">
                                                        We notice every nomination we are getting. We are reviewing each
                                                        and every one of them and will try our best to do justice with
                                                        your entry. Please read <a href="/"
                                                            style="color: #106c97;text-decoration: none;">Our FAQs</a> to
                                                        understand what can be the possible steps ahead.
                                                    </div>
                            ...
                            <tr>
                                <td height="10" style="background-color: #00000006"></td>
                            </tr>
                        </tbody>
                    </table>
                </td>
