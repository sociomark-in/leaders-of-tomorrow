...
<div class="wrapper">
	...
	<div class="examples">
		<a href="<?= base_url('auth/example/web_login') ?>" class="web">Redirect Login<br/>Example</a>
		<a href="<?= base_url('auth/example/js_login') ?>" class="js">Javascript Login<br/>Example</a>
	</div>
