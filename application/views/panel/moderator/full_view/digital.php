							...
							<div class="col-12">
								<fieldset class="col-12">
									...
									<div class="row g-3">
										...
										<div class="col-xl-4 col-lg-6 col-12">
											<div class="">
												<p class="form-label">Percentage of business processes impacted by digital technologies</p>
										...
										<div class="col-xl-4 col-lg-6 col-12">
											<div class="">
												<p class="form-label">Number of digital tools/technologies adopted in the last 2 years</p>
						...
						<div class="row g-4 g-lg-5">
							<fieldset class="col-12">
								...
								<div class="row g-3">
									<div class="col-12">
										<div class="">
											<p class="form-label">Describe the digital technologies (e.g., AI, IoT) that your company has integrated into its operations. How did these technologies help in transforming your business model or customer experience</p>
							...
							<fieldset class="col-12">
								...
								<div class="row g-3">
									<div class="col-12">
										<div class="">
											<p class="form-label">How has the integration of digital technologies impacted your company&#39;s performance in terms of revenue, customer satisfaction, and market share? Please provide any specific metrics or examples.</p>
							...
							<fieldset class="col-12">
								...
								<div class="row g-3">
									<div class="col-12">
										<div class="">
											<p class="form-label">Describe how digital technologies have improved the sustainability of your operations, such as reducing waste, enhancing energy efficiency, or optimizing resource use</p>
							...
							<fieldset class="col-12">
								...
								<div class="row g-3">
									<div class="col-12">
										<div class="">
											<p class="form-label">How scalable are the digital solutions your company has implemented? Describe the potential for expanding the use of digital technologies within your business?</p>
