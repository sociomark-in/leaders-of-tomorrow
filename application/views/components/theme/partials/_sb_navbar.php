<nav class="sub-navbar navbar navbar-expand-lg">
	<div class="container-fluid">
		<a class="navbar-brand" href="<?= base_url('city/' . strtolower($city['name'])) ?>">
			<img src="<?= base_url("assets/images/") ?>favicon.png" alt="" class="mb-2" height="50">
			<?= $city['name'] ?> Spring Board
		</a>
		...
		<div class="mx-0 mx-md-4 collapse navbar-collapse w-100 justify-content-between" id="springboardNavbarNav">
			...
			<ul class="navbar-nav gap-2">
				...
				<li class="nav-item">
					<a class="nav-link" href="<?= base_url('') ?>">Return to Home</a>
				</li>
			</ul>
		</div>
