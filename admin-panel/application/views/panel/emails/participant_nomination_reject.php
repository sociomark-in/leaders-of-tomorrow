...
<head>
	...
	<title>Update on Your Nomination - Leaders of Tomorrow Awards 2026</title>
	<!--[if mso]>
  <noscript>
    <xml>
												...
												<td style="line-height:22px;padding:0 30px 0">
													...
													<div>
														...
														<div style="margin-bottom:10px;line-height:1.5">
															...
															<a style="text-decoration: none; color:#b72026;" href="<?= base_url('my-nominations') ?>">(#<?= $application['nomination_id'] ?>)</a> 
															under the category 
