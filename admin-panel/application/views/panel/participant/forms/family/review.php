						...
						<div class="row g-3">
							...
							<div class="col-xxl-2 col-xl-4 col-lg-6 col-12">
								<div class="">
									...
									<input required type="text" name="organization[industry]" value="<?= $application['id_255000'] ?? '' ?>" class="form-control">
								</div>
							</div>
							...
							<div class="col-xxl-3 col-xl-4 col-12">
								<div class="">
									...
									<input type="number" min="0" name="organization[leading]" value="<?= $application['id_255006'] ?? '' ?>" class="form-control">
										...
										<?php if (isset($equity) && is_array($equity)) : ?>
											<?php foreach ($equity as $index => $partner) : ?>
												<tr>
													...
													<td>
														<input type="text" class="form-control" name="partner[<?= $index ?>][relation]" value="<?= $partner['designation'] ?? '' ?>">
													</td>
													<td>
														<select name="partner[<?= $index ?>][generation]" class="form-select">
															<option value="">Select Generation</option>
															<option value="1st" <?= ($partner['generation'] ?? '') === '1st' ? 'selected' : '' ?>>1st</option>
															<option value="2nd" <?= ($partner['generation'] ?? '') === '2nd' ? 'selected' : '' ?>>2nd</option>
															<option value="3rd" <?= ($partner['generation'] ?? '') === '3rd' ? 'selected' : '' ?>>3rd</option>
															<option value="4th" <?= ($partner['generation'] ?? '') === '4th' ? 'selected' : '' ?>>4th</option>
															<?php for ($j = 5; $j <= 10; $j++): ?>
																<option value="<?= $j ?>th" <?= ($partner['generation'] ?? '') === $j . 'th' ? 'selected' : '' ?>><?= $j ?>th</option>
															<?php endfor ?>
														</select>
													</td>
													<td>
