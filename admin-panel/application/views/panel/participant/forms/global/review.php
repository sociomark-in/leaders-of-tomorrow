				...
				<div class="row g-md-5 g-3">
					...
					<fieldset class="col-12">
						...
						<div class="row g-3 mb-3">
							...
							<div class="col-xl-3 col-lg-4 col-md-6 col-12">
								<div class="">
									<label for="" class="form-label">Proof of Global Presence&nbsp;<a class="link-icon" href="<?= base_url($application['id_255402']) ?>" target="_blank">View Document<i class="mb-1 px-1" data-feather="external-link"></i></a></label>
							...
							<!-- <div class="col-xl-3 col-lg-4 col-md-6 col-12">
								<div class="">
									...
									<input type="file" accept="application/pdf" name="doc3" class="dropify" data-default-file="<?= $application['id_75532'] ?>" data-max-file-size="2M" data-allowed-file-extensions="pdf" />
