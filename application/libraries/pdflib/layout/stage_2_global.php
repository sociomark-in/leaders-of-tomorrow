...
$this->pdf->SetFont('Arial', '', 16);
$this->pdf->Cell(70, 15, "No. Of Employees Global", 1, 0, '', false);
$this->pdf->Cell(70, 15, $data['id_255009'] . " Employees" ?? "", 1, 0, '', false);
$this->pdf->Cell(20, 15, "", 0, 0, true);
...
$this->pdf->Cell(300, 15, "Countries", 1, 1, false);
$this->pdf->SetFont('Arial', '', 16);
$this->pdf->MultiCell(300, 15, ucwords(strtolower($data['id_255004'])), 1, 'L');
...
$this->pdf->addPage();
$this->pdf->SetFont('Arial', 'B', 18);
$this->pdf->MultiCell(300, 10, ucwords(strtolower("Details of Cross-Border Collaborations/Partnerships Established")), 0, 'L');
$this->pdf->SetFont('Arial', '', 16);
...
$this->pdf->addPage();
$this->pdf->SetFont('Arial', 'B', 18);
$this->pdf->MultiCell(300, 10, ucwords(strtolower("Market Expansion in the Last 2 Years")), 0, 'L');
$this->pdf->SetFont('Arial', '', 16);
$this->pdf->Cell(300, 7, "", 0, 1, '', false);
