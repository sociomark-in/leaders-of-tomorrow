						...
						<div class="row g-3 mb-3">
							...
							<!-- <div class="col-xl-3 col-lg-4 col-md-6 col-12">
								<div class="">
									...
									<input type="file" accept="application/pdf" name="doc3" class="dropify" data-default-file="<?= $application['id_255406'] ?>" data-max-file-size="2M" data-allowed-file-extensions="pdf" />
